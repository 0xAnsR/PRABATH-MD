...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "07FwnD5I#es-FwGdbxaKkfoPWFxZAgTxsxGromnjWZ1knw9AMYuw",
BOT_NUMBER: process.env.BOT_NUMBER || "923705084200",
PASSWORD: process.env.PASSWORD || "password",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "0xAnsR",
GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN || "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"
};
